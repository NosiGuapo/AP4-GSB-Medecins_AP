...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    // GET
    List<User> findByFnameContainingIgnoreCase(String fname); // Finding with first name only
    List<User> findByLnameContainingIgnoreCase(String lname); // Finding with last name only
//    List<User> findByLnameAndFname(String name); // Finding with both first and last names
    List<User> findByUsernameContainingIgnoreCase(String username); // Finding with username only
